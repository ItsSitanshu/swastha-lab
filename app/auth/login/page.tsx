                ...
                <div className="w-1/2 h-full relative flex flex-col font-nue items-center justify-center ">
                    <div className="w-10/12 h-5/6 flex flex-col font-nue items-center justify-center bg-background text-foreground rounded-3xl">
                        <div className="w-9/12 flex flex-col items-center justify-center pt-16">
                            <h1 className="text-foreground font-bebas text-3xl">Login to your Account</h1>
                            <p className="text-foreground/[.5] font-jksans text-lg">Welcome back! We missed you being here</p>
                            <AuthButton />
                            <AuthLoginForm />
                        </div>
                    </div>
                    ...
                    <div className="flex w-full h-1/2 pb-14 mx-12 justify-end gap-5 items-end">
                        ...
                        <div className="flex flex-col w-1/3 aspect-[1/1.4] bg-gradient-to-br from-white via-white/90 to-white/80 rounded-xl p-3 z-50">
                            <div className="flex flex-col h-2/3 w-full">
                                ...
                                <div className="flex flex-row w-full">
                                    <div className="flex flex-col w-2/3">
                                        ...
                                        <div className="flex flex-col w-full">   
                                            <h1 className="font-nue text-xs text-black/60 text-bold font-thin">NAME</h1>
                                            <p className="font-jksans text-black text-[1em] font-semibold">Grace Thapa</p>
                                        </div>
                                        <div className="flex flex-col w-full">   
                                            <h1 className="font-nue text-xs text-black/60 text-bold font-thin">DOB</h1>
                                            <p className="font-jksans text-black text-[1em] font-semibold">24-02-1998</p>
                                        </div>
                                        <div className="flex flex-col w-full">   
                                            <h1 className="font-nue text-xs text-black/60 text-bold font-thin">ID Number</h1>
                                            <p className="font-jksans text-black text-[1em] font-semibold">20210125</p>
                                        </div>
                                ...
                                <div className="flex flex-col w-full">   
                                    <h1 className="font-nue text-xs text-black/60 text-bold font-thin">RESIDENCE</h1>
                                    <p className="font-jksans text-black text-[1em] font-semibold">Koteshwor, Kathmandu</p>
                                </div>
                                <div className="flex flex-row w-full">
                                    <div className="flex flex-col w-1/2">   
                                        <h1 className="font-nue text-xs text-black/60 text-bold font-thin">Age</h1>
                                        <p className="font-jksans text-black text-[1em] font-semibold">55 Years</p>
                                    </div>
                                    <div className="flex flex-col w-1/2">   
                                        <h1 className="font-nue text-xs text-black/60 text-bold font-thin">Sex</h1>
                                        <p className="font-jksans text-black text-[1em] font-semibold">Male</p>
                                    </div>
                                </div>
                                <div className="flex flex-row w-full">
                                    <div className="flex flex-col w-1/2">   
                                        <h1 className="font-nue text-xs text-black/60 text-bold font-thin">Blood Group</h1>
                                        <p className="font-jksans text-black text-[1em] font-semibold">A/ve+</p>
                                    </div>
                                    <div className="flex flex-col w-1/2">   
                                        <h1 className="font-nue text-xs text-black/60 text-bold font-thin">Prefered Inst.</h1>
                                        <p className="font-jksans text-black text-[1em] font-semibold">KIST Medical..</p>
                                    </div>
                                </div>
                                <div className="flex flex-row w-full pt-2 justify-between items-center">
                                    <div className="flex justify-center items-center aspect-square w-1/5 rounded-full bg-black transition duration-300">
                                        <Image src={documentsIcon} alt="Documents" className="w-full p-2" />
                                    </div>
                                    <div className="flex justify-center items-center aspect-square w-1/5 rounded-full bg-black transition duration-300">
                                        <Image src={allergenIcon} alt="Allergen" className="w-full p-2" />
                                    </div>
                                    <div className="flex justify-center items-center aspect-square w-1/5 rounded-full bg-black transition duration-300">
                                        <Image src={calendarIcon} alt="Calendar" className="w-full p-2" />
                                    </div>
                                    <div className="flex justify-center items-center aspect-square w-1/5 rounded-full bg-black transition duration-300">
                                        <Image src={syringeIcon} alt="Syringe" className="w-full p-2" />
                                    </div>
                                    </div>
                                </div>
                            </div>
